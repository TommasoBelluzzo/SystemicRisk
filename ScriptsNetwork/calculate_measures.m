...
% grp   = A vector whose values represent the delimiters betweeen the different firm sectors.
...
function [dci,n_io,n_ioo,degc,cloc,cluc,eigc] = calculate_measures(adjm,grp)
