...
function adjacency_matrix = calculate_adjacency_matrix(varargin)
    ...
    adjacency_matrix = calculate_adjacency_matrix_internal(ipr.data,ipr.significance,ipr.robust);

end

function adjacency_matrix = calculate_adjacency_matrix_internal(data,significance,robust)
