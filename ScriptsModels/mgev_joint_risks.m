...
%
% [OUTPUT]
% joint_vars = A row vector of floats [0,Inf) representing the joint values-at-risk.
% joint_es = A float [0,Inf) representing the joint expected shortfall.

function [joint_vars,joint_es] = mgev_joint_risks(varargin)
    ...
    [joint_vars,joint_es] = mgev_joint_risks_internal(l,k);

end

function [joint_vars,joint_es] = mgev_joint_risks_internal(l,k)
    ...
    joint_vars = zeros(1,numel(q_fin));
